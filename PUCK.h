...
void initializePucks(PUCK &puckLeft, PUCK &puckRight) {
  puckLeft = {STARTING_PUCK_LEFT_X, STARTING_PUCK_LEFT_Y - 1, 1, 3, 0, 0, 0, 3, 0};
  puckRight = {STARTING_PUCK_RIGHT_X, STARTING_PUCK_RIGHT_Y - 1, 1, 3, 1, 0, 0, 0, 3};
}
